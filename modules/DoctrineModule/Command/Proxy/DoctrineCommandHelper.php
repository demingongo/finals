...
/**
 * Provides some helper and convenience methods to configure doctrine commands in the context of modules
...
abstract class DoctrineCommandHelper
{
    ...
    {
        $connection = $application->getApp()->getContainer()->get('managers')->getConnection($connName);
        $helperSet = $application->getHelperSet();
