<?php
$config = include 'config/config_novice.php';

/*** modif Novice code **/
if (isset($_GET['base_url'])){
	$config['upload_dir'] = $_GET['base_url'] . $config['upload_dir'];
}
/** **/
...
if (!isset($_SESSION['RF']['allow_acces']) || $_SESSION['RF']['allow_acces'] == FALSE)
{
	die('Access Denied!');
}
...
/*** modif Novice code **/
if (isset($_GET['base_url'])){
	$get_params['base_url'] = $_GET['base_url'];
}
/** **/
	...
	<div class="tabbable upload-tabbable"> <!-- Only required for left/right tabs -->
	    ...
	    <div class="tab-content">
			<div class="tab-pane active" id="tab1">
		    	<?php } ?>
				<form action="dialog_novice.php" method="post" enctype="multipart/form-data" id="rfmDropzone" class="dropzone">
...
<!-- header div end -->
    ...
    <div class="row-fluid">
	<?php
	$link="dialog_novice.php?".$get_params;
	?>
	<ul class="breadcrumb">
	...
	<li class="pull-right"><a id="refresh" class="btn-small" href="dialog_novice.php?<?php echo $get_params.$subdir."&".uniqid() ?>"><i class="icon-refresh"></i></a></li>
		...
		foreach ($files as $file_array) {
		  $file=$file_array['file'];
			...
			?>
			    ...
			    <?php } ?>
				  <a class="folder-link" href="dialog_novice.php?<?php echo $get_params.rawurlencode($src)."&".uniqid() ?>">
			...
			<?php }else{ ?>
				    ...
				    <div class="box">
					<h4 class="<?php if($ellipsis_title_after_first_row){ echo "ellipsis"; } ?>"><a class="folder-link" data-file="<?php echo $file ?>" href="dialog_novice.php?<?php echo $get_params.rawurlencode($src)."&".uniqid() ?>"><?php echo $file; ?></a></h4>
				    </div>
