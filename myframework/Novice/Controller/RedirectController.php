...
class RedirectController extends BackController
{
     ...
     * @return Response A Response instance
     */
    public function executeUrlRedirect(Request $request)//, $path, $permanent = false, $scheme = null, $httpPort = null, $httpsPort = null)
    {
		$attrs = $request->attributes;

		$path      = $attrs->get('path');
		$permanent = $attrs->has('permanent') ? $attrs->get('permanent') : false;
		$scheme    = $attrs->has('scheme') ? $attrs->get('scheme') : null;
		$httpPort  = $attrs->has('httpPort') ? $attrs->get('httpPort') : null;
		$httpsPort = $attrs->has('httpsPort') ? $attrs->get('httpsPort') : null;
