...
use \HTMLPurifier_ConfigSchema as HTMLPurifier_ConfigSchema;
use \HTMLPurifier as HTMLPurifier;

class HTMLPurifierApplication
{ 
  ...
  public function __construct(Array $allowed = array()){
	  $this->purifier = self::load_htmlpurifier($allowed);
  }

  public static function setAllowed(Array $newAllowed = array())
  {	  
	  $allowed = array(
  ...
  'hr'
	...
	$allowed = array_merge($newAllowed , $allowed);

    
	self::$purifier = self::load_htmlpurifier($allowed);
  }

  public static function addAllowed(Array $newAllowed = array())
  {	  
	  $allowed = array(
  'img[src|alt|title|width|height|style|data-mce-src|data-mce-json]',
  'figure', 'figcaption',
 ...
 */
 ...
 private static function load_htmlpurifier($allowed) {
  $config = HTMLPurifier_Config::createDefault();
  $config->set('HTML.Doctype', 'HTML 4.01 Transitional');
  $config->set('CSS.AllowTricky', true);
  $config->set('Cache.SerializerPath', dirname(__FILE__) . '/../web/build');
